...
def export_web_json(
    ...
    # JS bundle — loads without fetch() (more reliable on GitHub Pages / file servers)
    js_path = out / "dashboard-data.js"
    body = json.dumps(payload, ensure_ascii=False, default=_json_default)
    with open(js_path, "w", encoding="utf-8") as f:
        f.write("/* auto-generated by pipeline.export_web — do not edit */\n")
        f.write("window.__OLIST_DASHBOARD__ = ")
        f.write(body)
        f.write(";\n")
    ...
    logger.info("Web export → %s", js_path)
